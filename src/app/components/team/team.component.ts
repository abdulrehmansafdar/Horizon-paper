...
export class TeamComponent {
  ...
  CEO: TeamMember = {
    ...
    experience:
      'Seasoned leader with extensive experience in paper manufacturing industry, driving strategic vision and operational excellence',
  };
  ...
  directors: TeamMember[] = [
    {
      ...
      role: 'Director',
      experience:
        'Strategic leadership and governance expertise, providing oversight and direction for organizational growth',
    },
    {
  ...
  seniorManagement: TeamMember[] = [
    ...
    },
    {
      ...
      experience:
        'MBA with expertise in market development and customer relationship management'
  ...
  operationalTeam: TeamMember[] = [
    {
      name: 'Amjad Mehmood',
      role: 'Admin Manager',
      experience:
        'Administrative operations specialist ensuring smooth organizational functioning',
    ...
    },
    {
      ...
      role: 'Internal Audit',
      experience:
        'Internal audit professional ensuring compliance and risk management',
